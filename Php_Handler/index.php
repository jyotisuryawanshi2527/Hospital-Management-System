...
<div class="wrapper col1">
  <div id="container">
    <div id="content">
      <h1>Welcome to Yashwantrao Chavan Rural Hospital</h1>
      ...
      <div class="homecontent">
        <ul>
          <li>
            ...
            <p class="imgholder"><a href="patientappointment.php"><img src="images/logo.png" alt="" style="width:286px;height:100px;" /></a></p>
          </li>
          <li class="last">
